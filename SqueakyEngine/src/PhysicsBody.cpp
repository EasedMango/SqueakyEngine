...
PhysicsBody::PhysicsBody() : Component(nullptr), transform(nullptr), isStatic(false), mass(1),  velocity(0), acceleration(0), prevAccel(0),  length(1), width(1), height(1), radius(1),  rotationAcceleration(0), rotationVelocity(0)
{
